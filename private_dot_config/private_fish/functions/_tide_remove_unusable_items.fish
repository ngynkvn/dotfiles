function _tide_remove_unusable_items
    ...
    set -l removed_items
    for item in aws crystal direnv distrobox docker elixir jj gcloud git go java kubectl nix_shell node php pulumi python ruby rustc terraform toolbox zig
